function Wait-TNServerReady {
    ...
    .EXAMPLE
        PS C:\> $null = Wait-TNServerReady -ComputerName nessus -AcceptSelfSignedCert:$AcceptSelfSignedCert

        Waits for a Nessus server to be ready for a maximum of 60 seconds
